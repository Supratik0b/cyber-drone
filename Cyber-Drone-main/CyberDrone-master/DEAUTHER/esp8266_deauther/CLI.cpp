/* This software is licensed under the MIT License: https://github.com/mastersubhajit/CyberDrone */
...
void CLI::runCommand(String input) {
    ...
    // ====== CHICKEN ===== //
    else if (eqlsCMD(0, CLI_CYBERDRONE)) {
        prntln(CLI_CYBERDRONE_OUTPUT);
    }
